...
SELECT name FROM people WHERE name = 'Iain Paterson';
...
-- Somehow the list of people includes someone just named 'David'. Change our mystery guest's name to 'David 5'
UPDATE people SET name = 'David 5' WHERE name = 'David';
-- The cinema has just heard that they will be holding an exclusive midnight showing of 'Spiderman Homecoming'!! Create a new entry in the 'movies' table to reflect this.
INSERT INTO movies (title, year, show_time) VALUES ('Spiderman Homecoming', 2017, '21:00');
-- The cinema would also like to make the Guardian's of the Galaxy movies a back to back feature. Update the 'Guardians of the Galaxy' show time from 16:15 to 18:30
UPDATE movies SET show_time = '18:30' WHERE show_time = '16:15';
